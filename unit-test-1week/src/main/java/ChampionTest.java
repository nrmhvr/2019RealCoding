...
public class ChampionTest {
    ...
    @Test
    public void 부동소수점체크(){
        assertThat(3.14, closeTo(3, 0.2)); // 성공
        assertThat(3.14, closeTo(3, 0.1)); // 실패
    }

    // 에러가 발생하면 fail
    // 2가 아닌 5 이상의 값을 참조하는 경우에는 에러 발생
    @Test
    ...
    public void 서폿챔피언은타릭이어야한다(){
        ...
        assertThat("타릭", equals(supportChamp.getName()));
    }
    ...
    public void shouldHaveSomeChampName(){
        List<String> championNames = Arrays.asList("루시안", "애쉬", "렉시아", "갈리오", "모르가나", "블라디미르");
